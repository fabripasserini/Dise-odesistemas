"""
Script para buscar el paquete PythonCinema desde el directorio raiz del proyecto.
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if comando == "integrar":
            ...
            print("  (sin argumentos)     Busca el paquete PythonCinema")
            ...
            print("  python buscar_paquete.py integrar PythonCinema")
            return 0
    ...
    print(f"[INFO] Buscando paquete: PythonCinema")
    print("")

    # Buscar el paquete
    paquetes = buscar_paquete(directorio_raiz, "PythonCinema")
    ...
    if paquetes:
        ...
        print("[!] No se encontro el paquete PythonCinema")
        return 1
